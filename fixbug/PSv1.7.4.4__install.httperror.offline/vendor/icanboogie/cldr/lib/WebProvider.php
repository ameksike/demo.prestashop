...
class WebProvider implements ProviderInterface
{
	...
	/*	fix:
			+ HTTP 200 - parsererror - Fatal error: Uncaught exception 'ICanBoogie\CLDR\ResourceNotFound' with message 'Path not defined: supplemental/codeMappings.'
			+ HTTP 200 - parsererror -
			+ HTTP 500 - parsererror -
			- " /vendor/icanboogie/cldr/lib/WebProvider.php "
